        ...
        <div>
            ...
            <div className="h-full px-3 pb-4 overflow-y-auto bg-transparent">
                <ul className="space-y-2 font-medium">
                    <li>
                        <Link href="/dashboard" className="flex items-center p-2 text-gray-300 rounded-lg hover:bg-emerald-500/20 hover:text-white group transition-colors">
                    ...
                    <li>
                        <Link href="/dashboard/income" className="flex items-center p-2 text-gray-300 rounded-lg hover:bg-emerald-500/20 hover:text-white group transition-colors">
